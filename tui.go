...
func RunTUI(report Report) (Report, selectionSnapshot, error) {
	...
	if !saved {
		return report, selectionSnapshot{}, nil
	}
...
func collectSelection(roots []*selectionNode) selectionSnapshot {
...
func collectNodeSelection(node *selectionNode, snapshot *selectionSnapshot) {
