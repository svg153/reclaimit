...
var categories = []Category{
	...
	newDirCategory("svelte-kit", ".svelte-kit", "SvelteKit build cache and generated types.", ".svelte-kit"),
	newDirCategory("astro-cache", ".astro", "Astro build cache that regenerates on next dev/build.", ".astro"),
	newDirCategory("parcel-cache", ".parcel-cache", "Parcel bundler cache.", ".parcel-cache"),
	newDirCategory("docusaurus", ".docusaurus", "Docusaurus build cache.", ".docusaurus"),
	...
	newDirCategory("kotlin-cache", ".kotlin", "Kotlin/Android build cache.", ".kotlin"),
	newDirCategory("nx-cache", ".nx", "Nx workspace cache and project build artifacts.", ".nx"),
	newDirCategory("turbo-cache", ".turbo", "Turborepo build cache.", ".turbo"),
	newDirCategory("swc-cache", ".swc", "SWC (Speedy Web Compiler) cache.", ".swc"),
	newDirCategory("vercel-cache", ".vercel", "Vercel build cache and preview deployment artifacts.", ".vercel"),
	...
	newDirCategory("npm-npx-cache", "_npx", "npx binary cache (Claude, Bun, etc.). Re-downloaded on next use.", "_npx"),
	...
	newDirCategory("apm-modules", "apm_modules", "APM-managed sub-modules (Gentle AI, skills).", "apm_modules"),
	newDirCategory("huggingface-models", ".cache/huggingface/hub", "Hugging Face downloaded models. Large but safe if not using offline inference.", ".cache/huggingface/hub"),
	newFileCategory("tsbuildinfo", "*.tsbuildinfo", "TypeScript incremental build info. Regenerated on next compile.", ".tsbuildinfo"),
	newFileCategory("vite-erb", "*.erb-*", "Vite hot-module-replacement cache artifacts.", "*.erb-*"),
	newFileCategory("patch-artifacts", "*.orig / *.rej", "Patch artifacts from git apply or patch. Leftover from merges.", "*.orig", "*.rej"),
}
