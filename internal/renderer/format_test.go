...
func TestRenderPlain(t *testing.T) {
	report := scanner.Report{
		...
		Candidates: []scanner.Candidate{
			{Path: "/tmp/test/node_modules", Bytes: 1048576, IsDir: true, Category: "node-modules", SafetyNote: "Can be reinstalled from lockfiles."},
			{Path: "/tmp/test/.DS_Store", Bytes: 100, IsDir: false, Category: "ds-store", SafetyNote: "Regenerated by macOS."},
		},
...
func TestRenderMarkdown(t *testing.T) {
	...
	if !strings.Contains(output, "Why reviewable") || !strings.Contains(output, "Can be reinstalled from lockfiles.") {
...
func TestRenderSelectionAndCleanupBranches(t *testing.T) {
	...
	report := scanner.Report{
		...
		SelectedCandidates:        []scanner.Candidate{{Path: "/tmp/a", Group: "/tmp/g|1", Bytes: 1, IsDir: true, SafetyNote: "Reviewable cache."}},
		SelectedBytes:             1,
		DeletedBytes:              1,
	...
	if !strings.Contains(jsonOutput, `"quarantine_path"`) || !strings.Contains(jsonOutput, `"clean_issues"`) || !strings.Contains(jsonOutput, `"safety_note"`) {
